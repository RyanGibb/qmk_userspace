...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  // base
  [0] = LAYOUT_moonlander(
    KC_MINS, KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    TG(3),           TG(5),   KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_EQUAL,
...
const uint8_t PROGMEM ledmap[][MATRIX_ROWS][MATRIX_COLS][3] = {
  ...
  [1] = LEDMAP_moonlander(
    ...
    _P_, _P_, _P_, _P_, _P_, xxx, xxx,                     xxx, xxx, _P_, _P_, xxx, _P_, _P_,
    _P_, xxx, _P_, _P_, _P_, xxx, xxx,                     xxx, _P_, _P_, _P_, _P_, _P_, xxx,
  ...
  [4] = LEDMAP_moonlander(
    ___, ___, ___, ___, ___, ___, ___,                     ___, ___, ___, ___, ___, ___, ___,
    ___, ___, ___, ___, ___, ___, ___,                     _R_, ___, ___, ___, ___, ___, ___,
    ___, ___, ___, ___, ___, ___, xxx,                     xxx, ___, ___, ___, ___, ___, ___,
